...
### Local System Fonts
- **System font access** - Use any font installed on your computer (Chromium browsers only, e.g. Chrome/Edge/Opera)
...
1. Open https://phomymo.affordablemagic.net in Chrome, Edge, Opera or another Chromium-based browser
...
- Chrome, Edge, Opera or another Chromium-based browser (desktop or Android)
- Web Bluetooth API support (not available in Firefox or Safari)
- WebUSB support for PM-241 printers (Linux: see [USB on Linux](#usb-on-linux))
- HTTPS or localhost
